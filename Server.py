...
class UserManager:
    ...
    def register_user(self, email, username, password, confirm_password, key_pair, public_key_pem):
...
class ClientHandler(threading.Thread):
    ...
    def handle_registration(self):
        ...
        self.send_message(key_pair.export_key().decode('utf-8'))
        self.send_message(public_key_pem.decode('utf-8'))

        success = self.user_manager.register_user(email, username, password, confirm_password, key_pair, public_key_pem)
