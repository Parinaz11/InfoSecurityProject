...
#             recipient_key = recipient_user.public_key.encode('utf-8')  # RSA.import_key(recipient_user.public_key)
...
# #         self.users = []
# #
# #     def register_user(self, email, username, password, confirm_password, public_key):
# #         if password != confirm_password:
# #             return False
# #
# #         if self.email_exists(email):
...
# #         hashed_password = self.hash_password(password, salt)
# #
# #         user = User(email, username, hashed_password, salt, public_key)
# #         self.users.append(user)
# #         return True
# #
# #     def login_user(self, username, password, address, p2p_port):
...
# #         recipient_user = self.user_manager.find_user_by_username(recipient_username)
# #         if recipient_user:
# #             print("found", recipient_user.username)
# #             self.send_message("P2P_INFO")
# #             self.send_message(f"{recipient_user.address}:{recipient_user.p2p_port}")
# #             print("SENDING " + recipient_user.public_key.decode('utf-8'))
# #             print("RAW:", recipient_user.public_key)
# #             self.send_message(recipient_user.public_key.decode('utf-8'))  # f"PEERPK{recipient_user.public_key.decode('utf-8')}"
# #         else:
# #             self.send_message("User does not exist.")
# #
# #
